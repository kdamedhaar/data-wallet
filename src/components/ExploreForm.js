            ...
            <div className={isLoading ? "disabled " : "visible form"}>
                ...
                <form>
                    <div className="formField">
                        <label className="formLabel" for="query"> Search Query : </label><br />
                        <input className="formInput" type="text" id="query" name="query" placeholder="Life of Pie" value={query} onChange={(e) => setQuery(e.target.value)} /><br />
                    </div>
